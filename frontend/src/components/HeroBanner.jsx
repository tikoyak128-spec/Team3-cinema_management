export default function HeroBanner({ badge, title, desc, image }) {
  return (
    <div className="relative min-h-[85vh] sm:min-h-[88vh] md:min-h-[90vh] lg:min-h-screen flex items-center justify-center overflow-hidden border-b border-white/5">
      <div
        className="absolute inset-0 bg-cover bg-center animate-[heroZoom_12s_ease-in-out_forwards]"
        style={{
          backgroundImage: image
            ? `url('${image}')`
            : `url('https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?w=1920&h=850&fit=crop')`,
        }}
      />
