...
class RoomSeeder extends Seeder
{
    ...
    [
            'cinema' => 'Khmer Cinema Taksim Mall',
            'name' => 'Room 1',
            'capacity' => 2,
            'total_seats' => 85,
        ],
    ...
    [
            'cinema' => 'Khmer Cinema Eden Garden',
            'name' => 'Room 1',
            'capacity' => 2,
            'total_seats' => 70,
        ],
    [
            'cinema' => 'Khmer Cinema Chip Mong 271',
            'name' => 'Room 1',
            'capacity' => 2,
            'total_seats' => 80,
        ],
    ...
    [
            'cinema' => 'Khmer Cinema K-Mall',
            'name' => 'Room 1',
            'capacity' => 2,
            'total_seats' => 60,
        ],
    [
            'cinema' => 'Khmer Cinema Heritage Walk',
            'name' => 'Room 1',
            'capacity' => 2,
            'total_seats' => 75,
        ],
